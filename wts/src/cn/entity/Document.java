...
public class Document implements java.io.Serializable {
	...
	private static final long serialVersionUID = -2287540842770927874L;
	...
	@Transient
	public boolean availableDnumber(String number) {
		if (!(number.matches("\\d{7}") || number.matches("\\d{8}"))) {
			return false;
		}
		if (number.length() == 7 && number.substring(2, 4).equals("01"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("02"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("03"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("04"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("05"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("06"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("07"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("08"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("09"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("10"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("11"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("12"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("13"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("14"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("16"))
			return true;
		else if (number.length() == 7 && number.substring(2, 4).equals("17"))
			return true;
		else if (number.length() == 8 && number.substring(0, 2).equals("20"))
			return true;
		else {
			return false;
		}
	...
	@Transient
	public int getLocationID(String number) {
		if (number.length() == 7 && number.substring(2, 4).equals("01"))
			return 1;
		else if (number.length() == 7 && number.substring(2, 4).equals("02"))
			return 2;
	...
	@Transient
	public boolean availablePnumber(String Number) {
		if (Number.matches("\\d{17}[0-9,X]")) {
			if (checkArea(Number)) {
				if (checkBirth(Number)) {
					if (checkOut(Number)) {
						return true;
					}
					return false;
	...
	@Transient
	private boolean checkArea(String Number) {
		...
		return areaCode.containsKey(Number.substring(0, 4));
	}

	@Transient
	private boolean checkBirth(String Number) {
		String Birth = Number.substring(6, 10) + "-" + Number.substring(10, 12)
				+ "-" + Number.substring(12, 14);
		SimpleDateFormat formatDate = new SimpleDateFormat("yyyy-MM-dd");
		try {
			Date BirthDate = (Date) formatDate.parse(Birth);
			Date DateBefore = (Date) formatDate.parse("1949-1-1");
			Date DateAfter = (Date) formatDate.parse("2050-12-31");
			if (BirthDate.after(DateBefore) && BirthDate.before(DateAfter)) {
				return true;
			}
			return false;
	...
	@Transient
	private boolean checkOut(String Number) {
		int i = (Integer.parseInt(Number.substring(0, 1)) * 7
				+ Integer.parseInt(Number.substring(1, 2)) * 9
				+ Integer.parseInt(Number.substring(2, 3)) * 10
				+ Integer.parseInt(Number.substring(3, 4)) * 5
				+ Integer.parseInt(Number.substring(4, 5)) * 8
				+ Integer.parseInt(Number.substring(5, 6)) * 4
				+ Integer.parseInt(Number.substring(6, 7)) * 2
				+ Integer.parseInt(Number.substring(7, 8)) * 1
				+ Integer.parseInt(Number.substring(8, 9)) * 6
				+ Integer.parseInt(Number.substring(9, 10)) * 3
				+ Integer.parseInt(Number.substring(10, 11)) * 7
				+ Integer.parseInt(Number.substring(11, 12)) * 9
				+ Integer.parseInt(Number.substring(12, 13)) * 10
				+ Integer.parseInt(Number.substring(13, 14)) * 5
				+ Integer.parseInt(Number.substring(14, 15)) * 8
				+ Integer.parseInt(Number.substring(15, 16)) * 4 + Integer
				.parseInt(Number.substring(16, 17)) * 2) % 11;
		if ((i == 0 && Number.substring(17, 18).equals("1"))
				|| (i == 1 && Number.substring(17, 18).equals("0"))
				|| (i == 2 && Number.substring(17, 18).equals("X"))
				|| (i == 3 && Number.substring(17, 18).equals("9"))
				|| (i == 4 && Number.substring(17, 18).equals("8"))
				|| (i == 5 && Number.substring(17, 18).equals("7"))
				|| (i == 6 && Number.substring(17, 18).equals("6"))
				|| (i == 7 && Number.substring(17, 18).equals("5"))
				|| (i == 8 && Number.substring(17, 18).equals("4"))
				|| (i == 9 && Number.substring(17, 18).equals("3"))
				|| (i == 10 && Number.substring(17, 18).equals("2"))) {
			return true;
		}
		return false;
	}
	...
	@Transient
	public Date getBirth(String Number) {
		Date date = null;
		try {
			date = new SimpleDateFormat("yyyy-MM-dd").parse(Number.substring(6,
					10)
					+ "-"
	...
	@Transient
	public int getSexID(String Number) {
		if (Number.substring(16, 17).equals("1")
				|| Number.substring(16, 17).equals("3")
				|| Number.substring(16, 17).equals("5")
				|| Number.substring(16, 17).equals("7")
				|| Number.substring(16, 17).equals("9")) {
			return 1;// 男
		}
		return 2;// 女
	}
